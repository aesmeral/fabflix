package edu.uci.ics.AESMERAL.service.gateway.configs;
    ...
    public BillingConfigs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if(discountCreatePath == null){
                System.err.println("Discount Create path not found in configuration file.");
            } else{
                System.err.println("Discount Create Path: " + discountCreatePath);
            }
            discountApplyPath = cm.getBillingEndpoints().get("discountApply");
            if(discountCreatePath == null){
                System.err.println("Discount Create path not found in configuration file.");
            } else{
                System.err.println("Discount Create Path: " + discountApplyPath);
            }
        }
    }
